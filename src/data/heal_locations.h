static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MARIGOLD_CITY_DAY - 1] = {MAP_GROUP(MARIGOLD_CITY_DAY), MAP_NUM(MARIGOLD_CITY_DAY), 50, 21},
    [HEAL_LOCATION_SIENNA_CITY_DAY - 1] = {MAP_GROUP(SIENNA_CITY_DAY), MAP_NUM(SIENNA_CITY_DAY), 0, 0},
    [HEAL_LOCATION_MINT_CITY - 1] = {MAP_GROUP(MINT_CITY), MAP_NUM(MINT_CITY), 0, 0},
    [HEAL_LOCATION_TAUPE_TOWN_DAY - 1] = {MAP_GROUP(TAUPE_TOWN_DAY), MAP_NUM(TAUPE_TOWN_DAY), 0, 0},
};
